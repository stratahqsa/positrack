...
| `/insights` | **AI Insights** | A proactive, auto-generated briefing — top issues now, since-yesterday deltas, most-behind people. Read-only over `snapshot.ai_brief`, baked in upstream by the Snapshot job (4x/day: 6am/12pm/4pm/7pm IST); fail-soft (renders a graceful "unavailable" state, never an error) when generation didn't succeed this cycle. |
...
- `ai_brief` — optional `AiBrief` (`lib/types.ts`): a proactive, AI-generated
  briefing baked into the snapshot upstream by the Snapshot job
