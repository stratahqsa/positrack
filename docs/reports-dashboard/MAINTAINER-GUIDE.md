...
- Data refreshes **automatically 4×/day (6am / 12pm / 4pm / 7pm IST)** from YouTrack.
...
- **Automatic:** a scheduled job runs **4×/day, at 6am / 12pm / 4pm / 7pm IST** — pulls
  YouTrack, builds the snapshot, publishes it. The dashboard can be up to ~11 hours
  behind on its own overnight (between the 7pm and 6am runs) — moved down from hourly
