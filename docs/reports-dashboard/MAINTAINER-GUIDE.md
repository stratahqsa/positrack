...
- Data refreshes **automatically 3×/day (8am / 12pm / 7pm IST)** from YouTrack. Nobody
...
```
YouTrack (support.posibolt.com)  ──►  Python scripts compute ONE snapshot (3x/day)
                                              │
                                              ▼
...
- **Automatic:** a scheduled job runs **3×/day, at 8am / 12pm / 7pm IST** — pulls
