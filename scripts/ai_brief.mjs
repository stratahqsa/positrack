...
- Whenever you state a "count" from "module_hotspot" or an "open_high"/"new_high" from "bug_kpi", also state its Urgent sub-count in the same sentence (e.g. "9 High/Urgent bugs, 1 of them Urgent") -- never blend High and Urgent into one number without saying how many are actually Urgent, since Urgent is usually a small handful and folding it in silently can make it look less serious than it is.
